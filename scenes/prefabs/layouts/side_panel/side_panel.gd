...
@onready var ribbon_scene = preload("res://scenes/prefabs/ui/ribbon/ribbon.tscn")
@onready var collapsible_field = preload("res://scenes/prefabs/ui/fields/collapsible_field/collapsible_field.tscn")
